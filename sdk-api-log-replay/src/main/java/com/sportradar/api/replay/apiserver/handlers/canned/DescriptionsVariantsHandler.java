...
class DescriptionsVariantsHandler extends TemplatedResponseApiHandler {

  public DescriptionsVariantsHandler(
  ...
  void populateInput(
    ...
    if (requestListener != null) {
      requestListener.received(ApiEndpoint.DescriptionsVariants, url, queryParameters);
    }
  }

  @Override
  String renderXmlTemplate(Map<String, Object> input) {
    return templateFactory.descriptionsVariants(input);
  }
}
