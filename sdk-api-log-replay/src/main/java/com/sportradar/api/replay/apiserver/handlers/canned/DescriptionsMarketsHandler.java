...
class DescriptionsMarketsHandler extends TemplatedResponseApiHandler {

  public DescriptionsMarketsHandler(
  ...
  void populateInput(
    ...
    if (requestListener != null) {
      requestListener.received(ApiEndpoint.DescriptionsMarkets, url, queryParameters);
    }
  }

  @Override
  String renderXmlTemplate(Map<String, Object> input) {
    return templateFactory.descriptionsMarkets(input);
  }
}
