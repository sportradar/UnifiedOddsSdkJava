...
public class FeedMessageFactoryTest {
    ...
    public void setup() throws Exception {
        ...
        sportEvent = entityFactory.buildSportEvent(
    ...
    public void buildsRollbackBetSettlement() throws Exception {
        UFRollbackBetSettlement msg = XmlMessageReader.readMessageFromResource(ROLLBACK_BET_SETTLEMENT_MSG_URI);

        RollbackBetSettlement<SportEvent> result = factory.buildRollbackBetSettlement(sportEvent, msg, rawMsg, timestamp);
    ...
    public void buildsRollbackBetCancel() throws Exception {
        ...
        RollbackBetCancel<SportEvent> result = factory.buildRollbackBetCancel(sportEvent, msg, rawMsg, timestamp);
    ...
    public void buildsCashoutProbabilities() throws Exception {
        ...
        CashOutProbabilities<SportEvent> result = factory.buildCashOutProbabilities(sportEvent, msg, timestamp);
