...
import static com.sportradar.unifiedodds.sdk.internal.caching.impl.ci.RaceStageCiToMergeTo.into;
import static com.sportradar.unifiedodds.sdk.internal.caching.impl.ci.RaceStageCis.exportSerializeAndUseConstructorToReimport;
import static com.sportradar.unifiedodds.sdk.internal.caching.impl.ci.RaceStageCis.usingConstructor;
...
public class RaceStageCiImplStageTypeTest {
    ...
    public static final String SPRINT_STAGES = PACKAGE_NAME + ".RaceStageCiImplStageTypeTest#sprintStages";
    public static final String RACE_STAGE_WITHOUT_STAGE_TYPE =
        PACKAGE_NAME + ".RaceStageCiImplStageTypeTest#raceStagesWithoutStageType";
