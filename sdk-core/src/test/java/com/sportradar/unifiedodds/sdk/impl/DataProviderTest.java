...
import static com.sportradar.unifiedodds.sdk.impl.Deserializers.customBetApiDeserializer;
import static com.sportradar.unifiedodds.sdk.impl.Deserializers.sportsApiDeserializer;
import static com.sportradar.unifiedodds.sdk.impl.HttpClients.*;
import static com.sportradar.unifiedodds.sdk.impl.HttpDataFetchers.createLogDataFetcher;
import static com.sportradar.unifiedodds.sdk.impl.HttpDataFetchers.createLogFastDataFetcher;
...
public class DataProviderTest {
    ...
    private static final String DATA_FETCHERS =
        "com.sportradar.unifiedodds.sdk.impl.DataProviderTest#dataFetchers";
    ...
    class PositiveResponses {
        ...
        void returnsDataForGetRequest(
            String description,
            DataProviderTimeoutTest.DataFetcherProvider dataFetcherProvider
        ) throws Exception {
        ...
        @MethodSource(DATA_FETCHERS)
        @ParameterizedTest(name = "{0}")
        void returnsDataForPostRequest(
            String description,
            DataProviderTimeoutTest.DataFetcherProvider dataFetcherProvider
        ) throws Exception {
            val cfg = configurationForApiWith1sClientTimeoutNoSslOn(apiBaseUrl.get());
    ...
    static Stream<Arguments> dataFetchers() {
        return Stream.of(
            Arguments.arguments(
                "NormalDataFetcher",
                (DataProviderTimeoutTest.DataFetcherProvider) cfg ->
