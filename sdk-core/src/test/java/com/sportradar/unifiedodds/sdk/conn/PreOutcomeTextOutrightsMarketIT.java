...
import static com.sportradar.unifiedodds.sdk.conn.UfMarkets.WithOdds.nascarOutrightsMarket;
...
class PreOutcomeTextOutrightsMarketIT {
    ...
    public PreOutcomeTextOutrightsMarketIT() throws Exception {}
    ...
    void fetchesTranslatedMarketNameForNascarOutrightsMarket(Locale language) throws Exception {
        globalVariables.setProducer(LIVE_ODDS);
        globalVariables.setSportEventUrn(SportEvent.MATCH);
        globalVariables.setSportUrn(Sport.NASCAR_CUP_SERIES);
        ...
        apiSimulator.stubMarketListContaining(nascarOutrightsMarketDescription(language), language);
        apiSimulator.stubSingleVariantMarket(nascarOutrightsMarketDescription(language), language);
        ...
        try (
            ...
            assertThat(market.getName(language))
                .isEqualTo(nascarOutrightsMarketDescription(language).getName());
        }
    }

    @ParameterizedTest
    @MethodSource("languages")
    void fetchesTranslatedOutcomeNamesForNascarOutrightsMarket(Locale language) throws Exception {
        globalVariables.setProducer(LIVE_ODDS);
        globalVariables.setSportEventUrn(SportEvent.MATCH);
        globalVariables.setSportUrn(Sport.NASCAR_CUP_SERIES);
        FeedMessageBuilder messages = new FeedMessageBuilder(globalVariables);
        ...
        try (
            ...
            OutcomesAssert
                ...
                .hasExactlyNamesAndIdsEqualTo(nascarOutrightsMarketDescription(language));
        }
    }
