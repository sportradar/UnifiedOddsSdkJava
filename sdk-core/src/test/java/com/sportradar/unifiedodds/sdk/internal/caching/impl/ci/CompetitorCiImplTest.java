...
public class CompetitorCiImplTest {
    ...
    private final Boolean virtualFlagNull = null;
    ...
    private SapiCompetitorProfileEndpoint createCompetitorProfileWithVirtualFlag(Boolean isVirtual) {
        SapiCompetitorProfileEndpoint competitorProfile = createWithDivisionAndDivisionName(
            anyDivision,
            anyDivisionName
        );
        SapiTeamExtended sapiTeam = competitorProfile.getCompetitor();
        sapiTeam.setVirtual(isVirtual);
