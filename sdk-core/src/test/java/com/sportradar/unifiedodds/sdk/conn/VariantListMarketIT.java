...
class VariantListMarketIT {
    ...
    VariantListMarketIT() throws Exception {}
    ...
    void fetchesTranslatedMarketAndOutcomeNamesForVariantListMarket(Locale language) throws Exception {
        ...
        apiSimulator.stubMarketListContaining(exactGoalsMarketDescription(language), language);
        apiSimulator.stubVariantListContaining(fivePlusVariantDescription(language), language);
        ...
        try (
            ...
            assertThat(market.getName(language)).isEqualTo(exactGoalsMarketDescription(language).getName());
            OutcomesAssert
                .assertThat(market.getOutcomeOdds())
                .hasExactlyNamesAndIdsEqualTo(fivePlusVariantDescription(language));
        }
    }
