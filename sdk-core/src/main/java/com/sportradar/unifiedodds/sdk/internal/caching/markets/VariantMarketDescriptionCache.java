...
import com.sportradar.unifiedodds.sdk.internal.impl.markets.MarketDescriptionImpl;
...
public class VariantMarketDescriptionCache implements MarketDescriptionCache {
    ...
    private final Map<String, Date> fetchedVariants = new ConcurrentHashMap<>();
    ...
    private MarketDescriptionCi loadMarketDescriptorData(
        ...
        try {
            for (Locale mLoc : locales) {
                ...
                MarketDescriptions data = fetchMarketDescriptionsFromApi(marketId, variant, mLoc);
    ...
    private MarketDescriptions fetchMarketDescriptionsFromApi(int marketId, String variant, Locale mLoc)
        ...
        try (
            LatencyTracker ignored = telemetryFactory.latencyHistogram(
                ...
                "VariantMarketDescription"
            )
        ) {
            return dataProvider.getData(mLoc, String.valueOf(marketId), variant);
        }
    }
