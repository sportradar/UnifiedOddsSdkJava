...
import com.sportradar.unifiedodds.sdk.internal.impl.oddsentities.RecoveryInfoImpl;
import com.sportradar.unifiedodds.sdk.managers.EventRecoveryRequestIssuer;
...
public class RecoveryManagerImpl
    ...
    private final TelemetryFactory usageTelemetryFactory;
    ...
    RecoveryManagerImpl(
        ...
        Preconditions.checkNotNull(usageTelemetryFactory);
        ...
        this.usageTelemetryFactory = usageTelemetryFactory;
    }
    ...
    void init() {
        ...
        activeProducers.forEach((id, p) ->
            perProducerInfo.computeIfAbsent(
                id,
                producerId -> new ProducerInfo(producerId, producerManager, timeUtils, usageTelemetryFactory)
            )
        );
    ...
    private ProducerInfo provideProducerInfo(int producerId) {
        return perProducerInfo.computeIfAbsent(
            ...
            pid -> {
                ...
                return new ProducerInfo(producerId, producerManager, timeUtils, usageTelemetryFactory);
            }
        );
    }
